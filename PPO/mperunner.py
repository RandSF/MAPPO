...
class MPERunner(Runner):
    ...
    def collect(self,step):
        ...
        values = np.array(np.split(t2n(value), self.n_rollout_threads))
    ...
    def eval(self,total_num_step):
        ...
        for eval_step in range(self.episode_length):
            ...
            eval_rnn_states[eval_dones==True]=np.zeros(((eval_dones==True).sum(), self.recurrent_N, self.hidden_size))